...
<div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
    <div class="card border">
        <div class="card-body">
            <form action="{{ route('root.product-slider-section-one.update') }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <select name="sub_cat_one" id="sub_cat_one" class="form-control sub-category">
                                ...
                                @foreach ($subCategories as $subCategory)
                                    <option
                                        {{ $productSliderSectionOne->sub_category == $subCategory->id ? 'selected' : '' }}
                        ...
                        <div class="form-group">
                            ...
                            <select name="child_cat_one" id="child_cat_one" class="form-control child-category">
                                ...
                                @foreach ($childCategories as $childCategory)
                                    <option
                                        {{ $productSliderSectionOne->child_category == $childCategory->id ? 'selected' : '' }}
